        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                ...
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('register')}}">Register|login</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="container">
        <div class="footer-banner" data-aos="fade-up">
            ...
            <div class="banner-btns-wrapper">
                ...
                <button class="btn btn-success"> <img src="{{asset('assets/images/apple@1x.svg')}}assets/images/android@1x.svg" alt="android" class="mr-2"> Google Play</button>
            </div>
